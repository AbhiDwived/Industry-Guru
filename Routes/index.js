...
// Comment routes
router.get("/comments/:productId", verifyUser, getCommentsByProductId);
router.put("/updatecomment/:commentId", verifyUser, updateComment);
router.delete("/deletecomment/:commentId", verifyUser, deleteComment);
router.post("/comments/:productId", verifyUser, createComment);
router.post("/comments/like/:commentId", verifyUser, likeComment);
router.post("/comments/dislike/:commentId", verifyUser, dislikeComment);
